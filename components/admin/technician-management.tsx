    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        ...
        {technicians.length === 0 ? (
          <div className="text-center text-sm text-gray-600 py-6 border border-dashed border-gray-300 rounded-lg bg-gray-50">
            No technicians available yet. Add your capture specialists to start assigning projects.
          </div>
        ) : (
        ...
        <Card className="p-6">
          ...
          <div className="space-y-2">
            {completedServices.length === 0 ? (
              <p className="text-sm text-gray-500 text-center py-4">No completed jobs logged.</p>
            ) : (
